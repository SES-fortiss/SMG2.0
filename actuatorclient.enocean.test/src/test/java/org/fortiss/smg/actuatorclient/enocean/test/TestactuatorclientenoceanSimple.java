...
public class TestactuatorclientenoceanSimple {

//	private actuatorclient.enoceanInterface impl;
...
//
	...
	public Option[] config() {
            ...
            Option[] currentSpace = options(
                            mavenBundle("org.fortiss.smartmicrogrid", "actuator.api",
                                            "1.0-SNAPSHOT"),
	...
	@Before
	public void setUp() {
//		impl = new ActuatorClientImpl(master, clientId, host, port, wrapperTag, pollFreq)
        }
