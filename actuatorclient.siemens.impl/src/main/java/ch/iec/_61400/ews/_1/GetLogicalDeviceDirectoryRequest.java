 ...
 *       &lt;sequence>
 *         &lt;element name="LDRef" type="{http://iec.ch/61400/ews/1.0/}tLogicalDeviceReference"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "GetLogicalDeviceDirectoryRequest")
public class GetLogicalDeviceDirectoryRequest {

    @XmlElement(name = "LDRef", required = true)
    protected String ldRef;
    ...
    /**
     * Sets the value of the ldRef property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setLDRef(String value) {
        this.ldRef = value;
    }
