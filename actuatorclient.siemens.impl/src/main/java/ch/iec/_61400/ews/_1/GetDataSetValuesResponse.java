 ...
 *       &lt;choice>
 *         &lt;element name="DataAttrVal" type="{http://iec.ch/61400/ews/1.0/}tDataAttributeValue" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "GetDataSetValuesResponse")
public class GetDataSetValuesResponse {

    @XmlElement(name = "DataAttrVal")
